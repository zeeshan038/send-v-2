...
const Register = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center font-sans dark:bg-zinc-950 bg-[#f8faff] transition-colors duration-300 px-4 pt-28 pb-10 relative overflow-hidden">
            ...
            {/* Background Blobs */}
            <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-indigo-500 opacity-[0.03] dark:opacity-[0.05] rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-500 opacity-[0.03] dark:opacity-[0.05] rounded-full blur-[100px] pointer-events-none" />
                ...
                <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-xl border border-white dark:border-zinc-800 shadow-[0_40px_100px_rgba(0,0,0,0.05)] dark:shadow-[0_40px_100px_rgba(0,0,0,0.4)] rounded-[32px] p-8 md:p-10">
                    ...
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-[14px] text-gray-500 dark:text-zinc-400 font-medium">
                            ...
                            <Link to="/login" className="text-[#2b3a8c] dark:text-blue-400 font-bold hover:underline underline-offset-4">Sign in here</Link>
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-8 text-gray-300 dark:text-zinc-800">
                        ...
                        <span className="text-[11px] text-gray-400 dark:text-zinc-500 uppercase font-black tracking-widest">or register</span>
                        <div className="flex-1 h-px bg-current" />
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-[12px] font-black text-gray-400 dark:text-zinc-500 uppercase tracking-wider ml-1">Full Name</label>
                                <input
                                    type="text"
                                    placeholder="John Doe"
                                    className="w-full h-14 px-5 rounded-2xl bg-gray-50/50 dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-700/50 focus:border-[#2b3a8c] dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[15px] dark:text-white font-medium"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[12px] font-black text-gray-400 dark:text-zinc-500 uppercase tracking-wider ml-1">Work Email</label>
                                <input
                                    type="email"
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[12px] font-black text-gray-400 dark:text-zinc-500 uppercase tracking-wider ml-1">Password</label>
                            <div className="relative">
                                <input
                                    type={showPass ? 'text' : 'password'}
                                    placeholder="Create a strong password"
                                    className="w-full h-14 px-5 pr-12 rounded-2xl bg-gray-50/50 dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-700/50 focus:border-[#2b3a8c] dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[15px] dark:text-white font-medium"
                                />
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[12px] font-black text-gray-400 dark:text-zinc-500 uppercase tracking-wider ml-1">Confirm Password</label>
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full h-14 px-5 pr-12 rounded-2xl bg-gray-50/50 dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-700/50 focus:border-[#2b3a8c] dark:focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[15px] dark:text-white font-medium"
                                />
                                <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-zinc-200 transition-colors">
                    ...
                    <p className="text-center text-[11px] text-gray-400 dark:text-zinc-500 mt-8 leading-relaxed font-medium">
                        By signing up, you agree to our <br />
                        <a href="#" className="font-bold text-gray-600 dark:text-zinc-300 hover:underline">Terms of Service</a> and <a href="#" className="font-bold text-gray-600 dark:text-zinc-300 hover:underline">Privacy Policy</a>
                    </p>
                </div>
            </motion.div>
        </div>
